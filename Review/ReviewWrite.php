		...
		<div class="container" >
			<div id="Write_area">
			  ...
			  ?>
				...
				<form name="write_form" id="write_form" action="write_ok.php" method="post"	enctype="multipart/form-data">
						<input class="form-control" type="text" name="a_ticketTitle" placeholder="제목" maxlength="100" required=""></input>
         <? if(isset($_SESSION['id'])){ ?>
						<input class="form-control" type="text" name="a_nick" readonly="readonly" maxlength="100" required="" value="<? echo $Myid["nick"]; ?>"></input>
         <? } else { ?>
						<input class="form-control" type="text" name="a_nick" placeholder="글쓴이" maxlength="100" required=""></input>
         <? } ?>
						<textarea class="nse_content" id="a_ticketContent" name="a_ticketContent" required=""></textarea>
						<!-- <div id="in_file">
							<input type="file" value="1" name="b_file"/>
						</div> -->
					<div class="bt_se">
						<input type="button" class="btn btn-primary submit mb-4" id="save_btn" value="글 쓰기"/>
					</div>
				</form>
				</div>
      </div>
