...
<body>
	...
	<section class="banner-bottom">
		<h3 class="tittle">Schedule List</h3>
		<div class="container">
      <div id="board_area">
          ...
          <tbody>
              ...
              <!-- 수정 필요
							...
							<td width="500"><a href="./ReviewRead.html?a_ticketNo=<?php echo $board['a_ticketNo']; ?>"><?php echo $a_ticketTitle;?></a></td>
	 	 ...
	 	 <ul>
			 ...
			 ?>
				 ...
				 <div id="write_btn">
	        <a href="./scheduleWrite.html"><button>글쓰기</button></a>
	       </div>
			</div>
		</div>
	</section>
